-- Mod Options
local mod_name = "Create" -- Replace with the name of your mod
local targetMajor, targetMinor, targetPatch = 1, 21, 3 -- 1.21.0.3 (Other versions not supported by Amethyst)
local config_options = {} -- Any additional options, see: https://github.com/AmethystAPI/Create/blob/main/README.md
...
-- The latest version can be found here: https://github.com/AmethystAPI/Create/blob/main/xmake.lua
