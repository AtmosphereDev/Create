...
```
const projectNamespace = "fx_create";
```
...
The icon identifier is determined by the file name, i.e. `textures/items/example_item.png` will become `fx_create:example_item`